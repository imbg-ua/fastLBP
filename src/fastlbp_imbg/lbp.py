...
def uniform_lbp_uint8_padded_absolute_patch_masked(image: np.ndarray, patch_mask: np.ndarray, patchsize: int, P: int, R: float, 
                                      abs_r: int, abs_c: int, 
                                      paddings_top_bottom_left_right: ArrayLike):
    """Compute the uniform LBPs for the image.
    ...
    return _uniform_lbp_uint8_padded_absolute_patch_masked(image, patch_mask, patchsize, P, R, abs_r, abs_c, top, bottom, left, right)
