...
def uniform_lbp_uint8_padded(image: np.ndarray, P: int, R: float, paddings_top_bottom_left_right: ArrayLike):
    """Compute the uniform LBPs for the image.
    ...
    return _uniform_lbp_uint8_padded(image, P, R, top, bottom, left, right)
